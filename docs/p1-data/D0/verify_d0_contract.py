...
MUST = [
    ...
    ("ERD_CONSTRAINTS.md", "设计性悬空内容句柄", "rev7-1"),
    ("ERD_CONSTRAINTS.md", "BYTES | PURGED | MISSING", "rev7-1"),
    ("ERD_CONSTRAINTS.md", "解除冻结经 fact_resolution_event", "rev7-2"),
    ("ERD_CONSTRAINTS.md", "### fact_erasure_event", "rev7-3"),
    ("ERD_CONSTRAINTS.md", "fact_payload_ref", "rev7-3"),
    ("ERD_CONSTRAINTS.md", "PAYLOAD | ERASED", "rev7-3"),
    ("ERD_CONSTRAINTS.md", "### collection_plan_item", "rev7-4"),
    ("ERD_CONSTRAINTS.md", "该窗口当时活跃的 plan 版本", "rev7-4"),
    ("FACT_LAYERING_CONTRACT.md", "fact_erasure_event", "rev7-3"),
    ("FACT_LAYERING_CONTRACT.md", "悬空句柄语义（rev7）", "rev7-1"),
    ("README.md", "rev7            = CURRENT", "rev7-0"),
]

FORBIDDEN = [
    "经此表 + contest_resolution_event",
    "每 Attempt 恰一个终态",
    "attempt_started_id",
